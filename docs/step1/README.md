...
> **참고**: 병목 현상을 명확히 확인하기 위해 VU를 10,000으로, 데이터셋 크기를 100,000개로 설정했습니다.
...
python generate-dataset.py --count 100000
```

> **참고**: 병목 현상을 명확히 확인하기 위해 데이터셋 크기를 100,000개로 설정했습니다. (기존: 10,000개)
