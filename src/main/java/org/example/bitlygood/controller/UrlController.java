...
public class UrlController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "URL 단축 성공", content = @Content(schema = @Schema(implementation = CreateUrlResponse.class))),
            @ApiResponse(responseCode = "400", description = "잘못된 요청 (중복된 alias 등)")
    })
    @PostMapping("/urls")
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "302", description = "리다이렉션 성공 (Location 헤더에 원본 URL 포함)"),
